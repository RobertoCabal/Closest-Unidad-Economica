    ...
    for codigo in codigo_act: 
        ...
        if len(denue_codigo)==0:
            ...
            for Lat,Lon in zip(lat,lon):
                ...
                denue_codigo['distance_to_point'] = denue_codigo['geometry'].apply(lambda p: (p.x-pt.x)**2+(p.y-pt.y)**2)
            ...
            df.loc[:,codigo+'_numero'] = numero_unidades_radius
            df.loc[:,codigo+'_duracion'] = duracion_minima_minutos
...
if __name__=='__main__':
    ...
    print(rue)
#       462111_numero  462111_duracion  462112_numero  462112_duracion
#0              2              4.0              4              2.0
#1              4              3.0              6              2.0